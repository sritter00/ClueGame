...
public class BoardAdjTargetTest306 {
	...
	public void testAdjacencyDoor()
	{
		...
		assertEquals(2, testList.size());
		assertTrue(testList.contains(board.getCell(2, 14)));
	...
	public void testTargetsInDiningRoom() {
		// test a roll of 1
		board.calcTargets(board.getCell(20, 12), 1);
		...
		// test a roll of 3
		board.calcTargets(board.getCell(20, 12), 3);
		...
		// test a roll of 4
		board.calcTargets(board.getCell(20, 12), 4);
		targets= board.getTargets();
	...
	public void testTargetsInKitchen() {
		...
		// test a roll of 3
		board.calcTargets(board.getCell(19, 20), 3);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.calcTargets(board.getCell(19, 20), 4);
		targets= board.getTargets();
		assertEquals(9, targets.size());
	...
	public void testTargetsInWalkway1() {
		// test a roll of 1
		board.calcTargets(board.getCell(2,11), 1);
		Set<BoardCell> targets= board.getTargets();
		assertEquals(2, targets.size());
		...
		// test a roll of 3
		board.calcTargets(board.getCell(2, 11), 3);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.calcTargets(board.getCell(2, 11), 4);
		targets= board.getTargets();
		assertEquals(3, targets.size());
		assertTrue(targets.contains(board.getCell(2, 14)));
		assertTrue(targets.contains(board.getCell(2, 8)));
	...
	public void testTargetsOccupied() {
		...
		board.getCell(7, 15).setOccupied(true);
		board.calcTargets(board.getCell(7, 13), 4);
		...
		assertTrue(targets.contains(board.getCell(9, 15)));
		assertTrue(targets.contains(board.getCell(5, 11)));	
		assertFalse( targets.contains( board.getCell(7, 15))) ;
		assertFalse( targets.contains( board.getCell(7, 17))) ;
	
		// we want to make sure we can get into a room, even if flagged as occupied
		board.getCell(20, 12).setOccupied(true);
		board.getCell(18, 8).setOccupied(true);
		board.calcTargets(board.getCell(17, 8), 1);
		board.getCell(20, 12).setOccupied(false);
		board.getCell(18, 8).setOccupied(false);
		targets= board.getTargets();
		assertEquals(3, targets.size());
		assertTrue(targets.contains(board.getCell(17, 7)));	
